package com.COSTADev.usuario.infrasctruture.security;
...
public class JwtUtil {
    ...
    private static final String chaveSecreta = "sua-chave-secreta-super-segura-que-deve-ser-bem-longa";
    ...
    public Claims extractClaims(String token) {
        return Jwts.parser()
                .setSigningKey(Keys.hmacShaKeyFor(chaveSecreta.getBytes(StandardCharsets.UTF_8))) // Define a chave secreta para validar a assinatura do token
                .build()
